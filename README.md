...
```text
fiap_fase5_farmtech_projeto_final/
├── src/
│   └── farmtech_analysis.py
├── SEU_NOME_COMPLETO_RM_pbl_fase4.ipynb
├── README.md
├── requirements.txt
└── .gitignore
```

## 3. Entrega 1 — Machine Learning
...
## 4. Entrega 2 — Computação em Nuvem (AWS)
...
## 4.4 Qual é a solução mais barata?
...
## 4.5 Qual região escolher se houver restrição legal para armazenamento no exterior?
...
## 4.6 Resposta final da Entrega 2
